...
public class ProductsController : ControllerBase
{
    ...
    {
        var product = await _context.Products.Include(p => p.Category).FirstOrDefaultAsync(p => p.IdProducto == id);
    ...
    public async Task<ActionResult<Product>> PostProduct(Product product)
    {
        ...
        return CreatedAtAction(nameof(GetProduct), new { id = product.IdProducto }, product);
    }
